...
{
    public class ModalEditorWeatherForecastControllerService
    {

        public ModalEditorWeatherForecastDataService DataService { get; set; }
        ...
        public ModalEditorWeatherForecastControllerService(ModalEditorWeatherForecastDataService weatherForecastDataService )
        {
