...
{
    public class ModalEditorWeatherForecastDataService
    {
        ...
        public ModalEditorWeatherForecastDataService()
        {
            PopulateForecasts();
        }
        ...
        public async Task<DbWeatherForecast> GetForecastAsync(Guid id)
        {
            await Task.Delay(500);
            return this.Forecasts.FirstOrDefault(item => item.ID.Equals(id));
        }
